...
;		SUBWF AUX_D1,D1 ;Resta aux_d1 con d1 
;		BTFSS STATUS,C	;Si la resta da negativa saltea
;		MOVWF AUX_D1    ;Mueve el resultado a Aux_d1
;		CALL NEGATIVO	;Llama a la rutina negativo 
;		SUBWF AUX_D2,D2 ;Resta aux_d2 con d2
;		BTFSS STATUS,C  ;Si la resta da negativa saltea
;		CALL NEGATIVO   ;Llama a la rutina negativa
;		SUBWF AUX_D3,D3 ;Resta aux_d3 con d3
 ;		BTFSS STATUS,C  ;Si la resta da negativa saltea
;		CALL NEGATIVO   ;Llama a la rutina negativo
;		SUBWF AUX_D4,D4 ;Resta aux_d4 con d4
;		BTFSS STATUS,C  ;Si la resta da negativa saltea
;		GOTO NEGATIVO   ;Va a negativo
